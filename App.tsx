...
const App: React.FC = () => {
  ...
  const handleClear = () => {
    ...
    handleUpdateCollaborator(activeId, 'unpaidVacationDays', 0);
        ...
        <div className="max-w-5xl mx-auto space-y-6 pb-12">
            ...
            <div className="flex flex-wrap gap-4 items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex gap-6 text-sm">
                    <div>
                        <p className="text-gray-400 text-xs">SDI Calculado</p>
                        <p className="font-semibold">{formatCurrency(results.sdi)}</p>
                    </div>
                    <div>
